...
export class PauserAdded extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save PauserAdded entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type PauserAdded must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("PauserAdded", id.toBytes().toHexString(), this);
    }
  }

  static load(id: Bytes): PauserAdded | null {
    return changetype<PauserAdded | null>(
      store.get("PauserAdded", id.toHexString())
    );
  }
...
export class PauserRemoved extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save PauserRemoved entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type PauserRemoved must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("PauserRemoved", id.toBytes().toHexString(), this);
    }
  }

  static load(id: Bytes): PauserRemoved | null {
    return changetype<PauserRemoved | null>(
      store.get("PauserRemoved", id.toHexString())
    );
  }
